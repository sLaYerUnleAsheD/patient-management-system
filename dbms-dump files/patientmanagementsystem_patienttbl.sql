...
--
-- Host: localhost    Database: patientmanagementsystem
-- ------------------------------------------------------
...
CREATE TABLE `patienttbl` (
  ...
  `PatAddress` varchar(85) NOT NULL,
...
INSERT INTO `patienttbl` VALUES ('Roronoa Zoro',2,'9556223650','East blue','14-05-1887','Female','Dust'),('Gang Bege',3,'9557223650','West blue','18-09-1998','Male','Spices');
...
-- Dump completed on 2022-01-27 17:25:30
